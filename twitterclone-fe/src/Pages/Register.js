                    ...
                    <div className='col-md-8 col-sm-12'>
                        <div className="card-body">
                            ...
                            <form onSubmit={(e) => register(e)}>
                                <input type="text" className="p-2 mt-4 mb-2 form-control " placeholder='Fullname' value={FullName} onChange={(ev) => setFullName(ev.target.value)} />
                                <input type="email" className="p-2 mt-4 mb-2 form-control " placeholder='Email' value={Email} onChange={(ev) => setEmail(ev.target.value)}/>
                                <input type="text" className="p-2 mt-4 mb-2 form-control " placeholder='Username' value={UserName} onChange={(ev) => setEmail(ev.target.value)} />
                                <input type="password" className="p-2 mt-4 mb-2 form-control " placeholder='Password' value={Password} onChange={(ev) => setEmail(ev.target.value)} />
                                <button type="button" className="btn btn-dark mt-4 mb-2 d-block">Register</button>
                            </form>
